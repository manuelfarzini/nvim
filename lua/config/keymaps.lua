...
vim.keymap.set("n", "<M-S-h>", ":vertical resize -4<CR>", { desc = "Resize left" })
vim.keymap.set("n", "<M-S-j>", ":resize -4<CR>", { desc = "Resize down" })
vim.keymap.set("n", "<M-S-k>", ":resize +4<CR>", { desc = "Resize up" })
vim.keymap.set("n", "<M-S-l>", ":vertical resize +4<CR>", { desc = "Resize right" })
